                ...
                <form action="listIdees" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-2 text-right">
                            <input type="text" name="idee_id" value="<c:out value="${topIdees.id}"/>" hidden>
                            <button type="submit" class="btn btn-light" name="like" value="1" title="Top">
                                <c:out value="${topIdees.top}"/>
                                Top
                            ...
                            <button type="submit" class="btn btn-light" name="dislike" value="2" title="Flop">
                                <c:out value="${topIdees.flop}"/>
                                Flop
