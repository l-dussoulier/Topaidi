              ...
              <div class="card shadow">
                     ...
                     <div class="card-body">
                            <blockquote class="blockquote mb-0">
                                   <div class="row">
                                   <div class="col-md-3">
                                          <img style="width: 15em;" class="card-img-top" src="<c:out value="data:image/jpeg;base64,${idees.lienImg}" />" alt="Aucune image">
                                   </div>
                                   <div class="col-md-5">
                                          ...
                                          <div class="card shadow" style=" overflow: scroll; height: 300px;">
                                                 <c:forEach items="${commentaire}" var="commentaire">
                                                        <c:if test="${ idees.id == commentaire.idee.id }" var="variable">
                                                               <p><span style="color: grey"><c:out value="${commentaire.user.username}" />: </span> <c:out value="${commentaire.content}"/></p>
                                                        </c:if>
                                                 </c:forEach>
                                          </div>
                                          <form action="listIdees" method="post">
                                                 <div class="input-group mb-3" style="margin-top: 10px;">
                                                        ...
                                                        <input class="form-control" type="text" placeholder="Ajouter un commentaire ..." class="form-control" id="commentaireInput" name="commentaire" required>
